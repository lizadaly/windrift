...
/***/ function(module, exports, __webpack_require__) {
	...
	var _windrift = __webpack_require__(2);
	...
	function start() {
	  var chaptersList = __webpack_require__(36);
	  var game = React.createElement(_windrift.Game, { chaptersList: chaptersList, config: _config2.default });
	  (0, _windrift.startGame)(game);
	}
	...
	exports.default = function (_ref) {
	  ...
	  var sections = [React.createElement(
	    ...
	    React.createElement(
	      'p',
	      null,
	      'You are standing in a spacious hall, splendidly decorated in red and gold, with glittering chandeliers overhead. The entrance from the street is to the ',
	      ...
	      ' and ',
	      React.createElement(_windrift.List, { expansions: ["west", "west"], tag: 'foyer_west' }),
	      '.'
	    ),
	    React.createElement(_windrift.Map, { from: inventory.foyer_south, to: {
	        south: function south() {
	          var barDark = React.createElement(
	            'p',
	            null,
	            ' It\u2019s pitch black. You\u2019re likely to fall over and hurt yourself. You can stumble ',
	            React.createElement(_windrift.List, { expansions: [["back north", "around randomly"], "back north"], tag: 'bar_north', nextUnit: null, conjunction: 'or' }),
	            '. '
	          );
	          return React.createElement(_windrift.Map, { from: inventory.bar_north, to: {
	              randomly: React.createElement(
	                ...
	                React.createElement(
	                  'p',
	                  null,
	                  'Like a complete clod, you flail around the dark bar, almost certainly messing things up.'
	                ),
	                React.createElement(
	                  'p',
	                  null,
	              ...
	              north: React.createElement(
	                ...
	                React.createElement(
	                  'p',
	                  null,
	                  'Putting out your hands, you\u2019re able to feel your way back to the bright foyer, though you note that as you step in, your cloak seems to draw light out of the room.'
	                )
	              )
	            } });
	        }
	    ...
	    React.createElement(
	      ...
	      React.createElement(_windrift.List, { expansions: ["one", "one jagged hook by the doorway "], tag: 'cloakroom_hook', nextUnit: null }),
	      ' remains.',
	      ...
	      '\xA0The exit is a ',
	      React.createElement(_windrift.List, { expansions: ["door", "door"], tag: 'cloakroom_door' }),
	      ' to the east.'
	    ),
	        ...
	        one: React.createElement(_windrift.Map, { from: inventory.cloak_hang, to: {
	            unselected: React.createElement(_windrift.Map, { from: inventory.bar_north, to: {
	                unselected: React.createElement(
	                  ...
	                  null,
	                  'Your ',
	                  React.createElement(_windrift.List, { expansions: ["cloak", "cloak"], tag: 'cloak_hang', nextUnit: null }),
	                  ' would look quite tidy hung up on that hook.'
	                ),
	                north: React.createElement(
	                  'p',
	                  null,
	                  'If you ',
	                  React.createElement(_windrift.List, { expansions: ["ditched", "carefully hung up"], tag: 'cloak_hang', nextUnit: null }),
	                  ' your cloak here, it might not absorb so much light from the bar.'
	                ),
	                randomly: React.createElement(
	                  'p',
	                  null,
	                  'If you ',
	                  React.createElement(_windrift.List, { expansions: ["ditched", "carefully hung up"], tag: 'cloak_hang', nextUnit: null }),
	                  ' your cloak here, it might not absorb so much light from the bar, assuming you haven\u2019t already irrevocably messed things up.'
	                )
	              } })
	          } })
	      } })
