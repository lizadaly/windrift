...
export default ({currentSection, inventory}) => {
    ...
    <section>
      ...
      <p>You look over the customer, who is wearing <List expansions={[
        "typical tourist clothes",
        ["a cheap wedding ring",
        "a dirty rain jacket",
        "a novelty baseball cap"],
        "an impatient stare"
      ]} tag="p0_customer_clothes"/>.</p>
    </section>,
    <section>
      <p>
        ...
        “<Map from={inventory.p0_customer_clothes} to={{
      ...
      <p>
        ...
        He perks up. You frown as if in deep concentration. “<List expansions={[
          "Nancy?",
          "Nadine?",
          "Nicky?"
    ...
    <section>
      ...
      <p>“Perhaps,” you hedge. “<Map from={inventory.p0_customer_clothes} to={{
      ...
      <p>“He didn’t approve of <Map from={inventory.p0_customer_clothes} to={{
      ...
      <p>“The world of the afterlife changes a person,” you say, gliding over his objection.
        You study the customer’s <List expansions={[
          "physical appearance",
          ["unshaven face",
          "calloused hands",
          "peeling sunburn"],
          "physical appearance and pick up some cues"
        ]} tag="p0_customer_body" />.</p>
    </section>,
    <section>
      <p>“<Map from={inventory.p0_customer_body} to={{
      ...
      <p>“It’s Detective. And I need a psychic,” she says, handing you
        her <List expansions={["card", 'card, which you flip over and read: "Tamisha Whitby, Criminal Investigations, Cape May County, NJ"']}  tag="p0_nextUnit"/>.
      </p>
    </section>,
    <section>
      <hr/>
    ...
    <section>
      <p><em>Something is very strange about that </em> <List expansions={["glove.", "— You pick up the glove, and everything changes."]} tag="p0_glove2"  /></p>
    </section>,
      <div className="in-flashback">
        ...
        <section>
          <p>You look down and see nothing, as if you aren’t there. The color
            ...
            a bookcase, a cluttered desk containing <List expansions={[
              "knicknacks",
    ...
    <section>
      <p>
        <Map from={inventory.p0_library_things} to={{
          note: <div>You look down at the unfinished note. It reads: <blockquote>My dearest, I hope you understand
            that I’m doing this based on need, not out of any lack of love for</blockquote> You don’t
            understand why, but you recognize the handwriting as Alan Healey’s.</div>,
    ...
    <section>
      ...
      <p><br/><br/><i>Read the rest of the story at <a href="https://stoneharborgame.com/">stoneharborgame.com</a></i></p>
      </section>
    ]
