...
test.describe('Full test of the built-in stories', () => {
    test('Runs through the manual application', async ({ page }) => {
        ...
        await expect(page.getByText('found 1 out of 4').first()).toBeVisible()
        ...
        await expect(page.getByText('found 2 out of 4').first()).toBeVisible()
        ...
        await expect(page.getByText('found 3 out of 4').first()).toBeVisible()
        await expect(page.getByText('time to meet up with your best friend').first()).toBeVisible()
